...
#アマゾン社で購入出来る安価なPC等で運用可能です（INTEL社N97やN95で処理時間は約80ミリ秒×カメラの台数となり、PC本体とカメラ１台の費用は3万円前後となります）（AMD社のRyzen7PRO6850Hの処理時間は約90ミリ秒×カメラの台数となり、PC本体とカメラ1台の費用は6万円前後となります）。
#
#環境設定
